...
function dehydrate(client, options = {}) {
  ...
  const filterMutation = (_c = (_b = options.shouldDehydrateMutation) != null ? _b : (_a13 = client.getDefaultOptions().dehydrate) == null ? void 0 : _a13.shouldDehydrateMutation) != null ? _c : defaultShouldDehydrateMutation;
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData = (_d = (_c = (_a13 = options == null ? void 0 : options.defaultOptions) == null ? void 0 : _a13.deserializeData) != null ? _c : (_b = client.getDefaultOptions().hydrate) == null ? void 0 : _b.deserializeData) != null ? _d : defaultTransformerFn;
...
function createRetryer(config) {
  ...
  const run = () => {
    ...
    Promise.resolve(promiseOrValue).then(resolve).catch((error) => {
      ...
      const retry = (_a13 = config.retry) != null ? _a13 : isServer ? 0 : 3;
...
var Query = (_a5 = class extends Removable {
  constructor(config) {
    ...
    this.state = (_a13 = config.state) != null ? _a13 : __privateGet(this, _initialState);
    this.scheduleGc();
  }
  get meta() {
    ...
    switch (action.type) {
      ...
      case "fetch":
        return {
          ...
          fetchMeta: (_a13 = action.meta) != null ? _a13 : null
        };
      case "success":
        const newState = {
          ...state,
...
var QueryObserver = (_a6 = class extends Subscribable {
  ...
  fetch(fetchOptions) {
    ...
    return __privateMethod(this, _executeFetch, executeFetch_fn).call(this, {
      ...fetchOptions,
      cancelRefetch: (_a13 = fetchOptions.cancelRefetch) != null ? _a13 : true
    }).then(() => {
      this.updateResult();
      return __privateGet(this, _currentResult);
    });
  ...
  var _a13;
  return (_a13 = typeof this.options.refetchInterval === "function" ? this.options.refetchInterval(__privateGet(this, _currentQuery)) : this.options.refetchInterval) != null ? _a13 : false;
    ...
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        if (direction && oldPages.length) {
          ...
          do {
            const param = currentPage === 0 ? (_a14 = oldPageParams[0]) != null ? _a14 : options.initialPageParam : getNextPageParam(options, result);
...
var Mutation = (_a7 = class extends Removable {
  ...
  continue() {
    var _a13, _b;
    return (_b = (_a13 = __privateGet(this, _retryer2)) == null ? void 0 : _a13.continue()) != null ? _b : this.execute(this.state.variables);
  }
  async execute(variables) {
    var _a13, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u;
    const onContinue = () => {
    ...
    __privateSet(this, _retryer2, createRetryer({
      ...
      onContinue,
      retry: (_a13 = this.options.retry) != null ? _a13 : 0,
...
var MutationObserver = (_a9 = class extends Subscribable {
  ...
  var _a13, _b;
  const state = (_b = (_a13 = __privateGet(this, _currentMutation)) == null ? void 0 : _a13.state) != null ? _b : getDefaultState2();
...
var QueryCache = (_a11 = class extends Subscribable {
  ...
  build(client, options, state) {
    ...
    const queryHash = (_a13 = options.queryHash) != null ? _a13 : hashQueryKeyByOptions(queryKey, options);
...
var QueryClient = (_a12 = class {
  ...
  invalidateQueries(filters, options = {}) {
    return notifyManager.batch(() => {
      ...
      return this.refetchQueries(
        {
          ...filters,
          type: (_b = (_a13 = filters == null ? void 0 : filters.refetchType) != null ? _a13 : filters == null ? void 0 : filters.type) != null ? _b : "active"
        },
        options
      );
    });
  ...
  refetchQueries(filters, options = {}) {
    ...
    const fetchOptions = {
      ...options,
      cancelRefetch: (_a13 = options.cancelRefetch) != null ? _a13 : true
    };
    const promises = notifyManager.batch(
...
function streamedQuery({
  ...
  return async (context) => {
    ...
    return (_a13 = context.client.getQueryData(context.queryKey)) != null ? _a13 : initialValue;
  };
}
